...
namespace Aula_05.Conteudo.Exercices
{
    public class Exercise_5_04
    {
        static void Main (string[] args)
        {
            ...
            for (int l = 0; l <= 4; l++)
            {
                individualaverage = (Convert.ToDouble(school[l, 1]) + Convert.ToDouble(school[l, 2]))/2;

                Console.WriteLine(school[l,0]+ " average");

                if (individualaverage > classaverage)
                    count++;
            }
